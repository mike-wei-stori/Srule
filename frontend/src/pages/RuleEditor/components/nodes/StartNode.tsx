...
import { Select, Input, Space, Typography, Tag, InputNumber, DatePicker, Button, Tooltip } from 'antd';
    ...
    return (
        <BaseNode {...props} style={{ maxWidth: 'none', minWidth: 350, width: 'auto' }}>
            ...
            <Space direction="vertical" size={6} style={{ width: '100%', marginTop: 8 }}>
                {actions.length > 0 && <Text type="secondary" style={{ fontSize: 12 }}>Initialization Actions:</Text>}
